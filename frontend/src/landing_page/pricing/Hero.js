        ...
        <div className="container">
            ...
            <div className="row p-5 mt-5 text-center">
                <div className="col-4 p-4">
                    <img src="media/images/pricingEquity.svg" alt="Equity Pricing Icon" />
                ...
                <div className="col-4 p-4">
                    <img src="media/images/intradayTrades.svg" alt="Intraday Trades Icon" />
                ...
                </div> <div className="col-4 p-4">
                    <img src="media/images/pricingEquity.svg" alt="MF Pricing Icon" />
